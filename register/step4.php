				  ...
				  <div class="bar3"></div>
								...
								<div class="collapse navbar-collapse" id="bs-navbar-collapse">
									<ul class="nav navbar-nav main-navbar-nav">
										...
										<li><a class="ovrbtn" href="../faq" title="">FREQUENTLY ASKED QUESTIONS</a></li>
    ...
    <section>
      ...
      <div class="col-md-8 container text-center" >
          ...
          <div class="track-page-outer text-center" id="tracking" >
              ...
              <div class="track-page-inner4">
                  
                  <h1>PAY AND PRINT RECIEPT</h1>
...
-->                        <li class="progtrckr-done">Payment & Reciept</li><!--
-->                     
                      </ol>                     
                  </div>
                  ...
                  <div class="col-sm-12 down1">
                      ...
                      <div class="form-group col-md-12">
                            <input type="text" class="form-control" id="phoneNumber" placeholder="Credit Card Number" name="phoneNumber" maxlength="11" required>  
                          </select>
                        ...
                        <div class="form-group col-md-12 row">
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="studentNumber" placeholder="Expiriry Date" name="studentNumber" required>
                     
                            </div>
                            
                            <div class="col-md-6" >
                                 <input style="float:right" type="text" class="form-control" id="studentNumber" placeholder="CV2" name="studentNumber" required>
                       ...
                       <div class="form-group col-md-12">
                            <input type="text" class="form-control" id="phoneNumber" placeholder="4 Digit Pin" name="phoneNumber" maxlength="11" required>  
                  ...
                  <div class="col-md-12 mg20" >
                    <div class="col-md-6" >
                     <a href="step3.php" class="back" style="float:left">BACK</a>
                    </div>

                    <div class="col-md-6" >
                            <a href="#x">
                      <button style="float:right; background-color: green" type="submit"  class="button2">
                      <span><span>PAY</span></span></button></a>
                    </div>
                  </div>
