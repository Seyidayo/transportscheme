...
Phone: (555) 555-5555</div>
            ...
            <div id="logo" style="width:252px; height:75px;">
              ...
              <img id="image" src="img/logoa-blk.png" width="100%" height="100%" alt="logo" />
            </div>
...
c/o Steve Widget
		...
		<table id="items" style="border-top:1px dashed black; margin-top 50px">
		<tr class="item-row">
		      <td class="item-name"><div class="delete-wpr">SSL Renewals</div></td>
		...
		<div style="background-color:#ffc922 ;height:40px">
